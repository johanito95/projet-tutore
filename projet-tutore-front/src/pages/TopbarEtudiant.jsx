...
const TopbarEtudiant = ({ toggleSidebar }) => {
  ...
  useEffect(() => {
    ...
    const fetchNotifications = async () => {
      try {
        ...
        setNotifications([
          { id: 1, message: 'Nouveau cours disponible', date: '2025-07-28', is_read: false },
          { id: 2, message: 'Note publiée pour UE101', date: '2025-07-27', is_read: false },
          { id: 3, message: 'Requête soumise', date: '2025-07-26', is_read: true },
        ]);
      ...
      <div className="bg-white/90 backdrop-blur-md shadow-md h-16 flex items-center justify-between px-6 fixed top-0 left-0 md:left-64 right-0 z-10 font-poppins">
        <div className="flex items-center gap-4">
          ...
          <div className="text-xl font-semibold text-[#093A5D]">
            {error ? 'Erreur' : user ? 'Étudiant' : 'Chargement...'}
          </div>
        </div>
